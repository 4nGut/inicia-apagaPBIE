<#
    .DESCRIPTION
        Este script apaga el servicio de Power BI Embedded utilizando PowerShell 5.1, previo a su ejecución es
...
try
{
	...
	Write-Output "Recurso Power BI Embedded Apagado Exitosamente"
}
catch
{
	Write-Error -Message $_.Exception
